...
it('should create paychecks for hourly rate employees', function () {
    $this->travelTo(Carbon::parse('2023-02-10'), function () {
...
it('should create paychecks for hourly rate employees only for the current month', function () {
    $this->travelTo(Carbon::parse('2023-02-10'), function () {
        $employee = Employee::factory([
            'hourly_rate' => 10 * 100,
            'payment_type' => PaymentTypes::HOURLY_RATE
...
it('should not create paychecks for hourly rate employees without timelogs', function () {
    $this->travelTo(Carbon::parse('2023-02-10'), function () {
        $employee = Employee::factory([
            'hourly_rate' => 10 * 100,
            'payment_type' => PaymentTypes::HOURLY_RATE
